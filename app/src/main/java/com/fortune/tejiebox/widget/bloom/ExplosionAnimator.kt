...
class ExplosionAnimator(container: View, bitmap: Bitmap, bound: Rect?) :
    ...
    companion object {
        ...
        private val X: Float = Utils.dp2Px(5).toFloat()
        private val Y: Float = Utils.dp2Px(20).toFloat()
        private val V: Float = Utils.dp2Px(2).toFloat()
        private val W: Float = Utils.dp2Px(1).toFloat()
    }
